use crate::handlers::{add_meta, add_timeseries, get_autarky, get_consumption, get_scope_two_emissions, get_self_consumption, get_timeseries_by_identifier, ping, read_meta, resample_timeseries_by_identifier, upload_timeseries};
